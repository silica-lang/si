...
/// The typed-AST→SIR lowering-utility layer (audit #35 P7-9a): SIR constructors,
/// AST→SIR conversions, post-lowering analysis, and const-evaluation, extracted
/// from this driver into a stable boundary the resolver calls into.
mod lower;
use lower::*;

/// The typecheck pass (audit #35 P7-9b): the per-value/statement semantic gates
/// (time-kind + value-type checking) as `Resolver` methods in their own file,
/// behind the P7-9a lowering boundary.
mod typeck;
